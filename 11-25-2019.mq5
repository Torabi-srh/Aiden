...
ENUM_TIMEFRAMES PeriodOverview = PERIOD_M30;
ENUM_TIMEFRAMES PeriodCalculation = PERIOD_M15;
ENUM_TIMEFRAMES PeriodTrailingStop = PERIOD_H1;
...
double lotsOptimized() {
   ...
   lot = ((MaximumRisk * margin) / 100) * _Point * leverage;
