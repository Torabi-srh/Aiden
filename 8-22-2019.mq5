...
input double      breath=55;                                                       // Breath between positions
input int      BreathLevel_M1=30;                                               // 1 Minutes TimeFrame     
input int      BreathLevel_M5=15;                                               // 5 Minutes TimeFrame         
input int      BreathLevel_M10=7;                                              // 10 Minutes TimeFrame
input int      BreathLevel_M15=5;                                              // 15 Minutes TimeFrame
input int      BreathLevel_M30=2;                                             // 30 Minutes TimeFrame
...
signal BBRSISignal(double Ask,double Bid,ENUM_TIMEFRAMES period=PERIOD_M1)
  {
   ...
   double iclose=iClose(_Symbol,period,1);
   double ihigh=iHigh(_Symbol,period,1);
   double ilow=iLow(_Symbol,period,1);
...
//+------------------------------------------------------------------+
double EMA(double &CArray[],double ema,int length)
  {
   double k=2/(length+1);
   return CArray[0]*k+ema*(1-k);
  }
//+------------------------------------------------------------------+
...
void MultiTimeFrameCalculator(double price_ask,double price_bid)
  {
   ...
   s_M5=ParabolicSAR(5,period_M5),
   s_M10=ParabolicSAR(5,period_M10),
   s_M15=ParabolicSAR(5,period_M15),
   s_M30=ParabolicSAR(5,period_M30);
...
signal ParabolicSAR(int length,ENUM_TIMEFRAMES period)
  {
   ...
   double iclosez=iClose(_Symbol,period,1);
   double ihighz=iHigh(_Symbol,period,1);
   double ilowz=iLow(_Symbol,period,1);
